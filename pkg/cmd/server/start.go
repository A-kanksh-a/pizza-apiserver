...
import (
	...
	"github.com/programming-kubernetes/pizza-apiserver/pkg/admission/plugin/pizzasize"
...
func (o *CustomServerOptions) Complete() error {
	...
	pizzasize.Register(o.RecommendedOptions.Admission.Plugins)
	...
	o.RecommendedOptions.Admission.RecommendedPluginOrder = append(o.RecommendedOptions.Admission.RecommendedPluginOrder, "PizzaSize")
	return nil
}
