...
import (
	...
	restaurantv2alpha1 "github.com/programming-kubernetes/pizza-apiserver/pkg/apis/restaurant/v2alpha1"
	...
	v2alpha1 "github.com/programming-kubernetes/pizza-apiserver/pkg/generated/listers/restaurant/v2alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RestaurantV2alpha1().Pizzas(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RestaurantV2alpha1().Pizzas(namespace).Watch(options)
			},
		},
		&restaurantv2alpha1.Pizza{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pizzaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restaurantv2alpha1.Pizza{}, f.defaultInformer)
}

func (f *pizzaInformer) Lister() v2alpha1.PizzaLister {
	return v2alpha1.NewPizzaLister(f.Informer().GetIndexer())
}
