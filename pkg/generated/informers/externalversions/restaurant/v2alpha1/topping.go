	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RestaurantV2alpha1().Toppings().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RestaurantV2alpha1().Toppings().Watch(options)
			},
		},
		&restaurantv2alpha1.Topping{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *toppingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&restaurantv2alpha1.Topping{}, f.defaultInformer)
}

func (f *toppingInformer) Lister() v2alpha1.ToppingLister {
	return v2alpha1.NewToppingLister(f.Informer().GetIndexer())
}
