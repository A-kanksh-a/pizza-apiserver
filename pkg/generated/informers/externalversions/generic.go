...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("pizzas"):
		...
		// Group=restaurant.programming-kubernetes.info, Version=v2alpha1
	case v2alpha1.SchemeGroupVersion.WithResource("pizzas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Restaurant().V2alpha1().Pizzas().Informer()}, nil
	case v2alpha1.SchemeGroupVersion.WithResource("toppings"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Restaurant().V2alpha1().Toppings().Informer()}, nil
