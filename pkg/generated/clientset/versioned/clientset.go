...
import (
	...
	restaurantv2alpha1 "github.com/programming-kubernetes/pizza-apiserver/pkg/generated/clientset/versioned/typed/restaurant/v2alpha1"
...
type Interface interface {
	...
	RestaurantV2alpha1() restaurantv2alpha1.RestaurantV2alpha1Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	restaurantV2alpha1 *restaurantv2alpha1.RestaurantV2alpha1Client
}
...
// RestaurantV2alpha1 retrieves the RestaurantV2alpha1Client
func (c *Clientset) RestaurantV2alpha1() restaurantv2alpha1.RestaurantV2alpha1Interface {
	return c.restaurantV2alpha1
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.restaurantV2alpha1, err = restaurantv2alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.restaurantV2alpha1 = restaurantv2alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.restaurantV2alpha1 = restaurantv2alpha1.New(c)
