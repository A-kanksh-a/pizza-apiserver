...
type ToppingInterface interface {
	Create(*v2alpha1.Topping) (*v2alpha1.Topping, error)
	Update(*v2alpha1.Topping) (*v2alpha1.Topping, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v2alpha1.Topping, error)
	List(opts v1.ListOptions) (*v2alpha1.ToppingList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha1.Topping, err error)
	ToppingExpansion
}
...
func newToppings(c *RestaurantV2alpha1Client) *toppings {
	return &toppings{
		client: c.RESTClient(),
	}
}
...
func (c *toppings) Get(name string, options v1.GetOptions) (result *v2alpha1.Topping, err error) {
	result = &v2alpha1.Topping{}
	err = c.client.Get().
		Resource("toppings").
		Name(name).
...
func (c *toppings) List(opts v1.ListOptions) (result *v2alpha1.ToppingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2alpha1.ToppingList{}
	err = c.client.Get().
		Resource("toppings").
...
func (c *toppings) Create(topping *v2alpha1.Topping) (result *v2alpha1.Topping, err error) {
	result = &v2alpha1.Topping{}
	err = c.client.Post().
		Resource("toppings").
		Body(topping).
...
func (c *toppings) Update(topping *v2alpha1.Topping) (result *v2alpha1.Topping, err error) {
	result = &v2alpha1.Topping{}
	err = c.client.Put().
		Resource("toppings").
		Name(topping.Name).
...
func (c *toppings) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha1.Topping, err error) {
	result = &v2alpha1.Topping{}
