...
type PizzaInterface interface {
	Create(*v2alpha1.Pizza) (*v2alpha1.Pizza, error)
	Update(*v2alpha1.Pizza) (*v2alpha1.Pizza, error)
	UpdateStatus(*v2alpha1.Pizza) (*v2alpha1.Pizza, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v2alpha1.Pizza, error)
	List(opts v1.ListOptions) (*v2alpha1.PizzaList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha1.Pizza, err error)
	PizzaExpansion
}
...
func newPizzas(c *RestaurantV2alpha1Client, namespace string) *pizzas {
	return &pizzas{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pizzas) Get(name string, options v1.GetOptions) (result *v2alpha1.Pizza, err error) {
	result = &v2alpha1.Pizza{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pizzas").
		Name(name).
...
func (c *pizzas) List(opts v1.ListOptions) (result *v2alpha1.PizzaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2alpha1.PizzaList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Create(pizza *v2alpha1.Pizza) (result *v2alpha1.Pizza, err error) {
	result = &v2alpha1.Pizza{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Update(pizza *v2alpha1.Pizza) (result *v2alpha1.Pizza, err error) {
	result = &v2alpha1.Pizza{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) UpdateStatus(pizza *v2alpha1.Pizza) (result *v2alpha1.Pizza, err error) {
	result = &v2alpha1.Pizza{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha1.Pizza, err error) {
	result = &v2alpha1.Pizza{}
