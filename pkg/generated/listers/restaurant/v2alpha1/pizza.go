...
type PizzaLister interface {
	...
	List(selector labels.Selector) (ret []*v2alpha1.Pizza, err error)
...
// List lists all Pizzas in the indexer.
func (s *pizzaLister) List(selector labels.Selector) (ret []*v2alpha1.Pizza, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v2alpha1.Pizza))
	})
	return ret, err
}
...
type PizzaNamespaceLister interface {
	...
	Get(name string) (*v2alpha1.Pizza, error)
...
// List lists all Pizzas in the indexer for a given namespace.
func (s pizzaNamespaceLister) List(selector labels.Selector) (ret []*v2alpha1.Pizza, err error) {
...
// Get retrieves the Pizza from the indexer for a given namespace and name.
func (s pizzaNamespaceLister) Get(name string) (*v2alpha1.Pizza, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v2alpha1.Resource("pizza"), name)
	}
	return obj.(*v2alpha1.Pizza), nil
}
