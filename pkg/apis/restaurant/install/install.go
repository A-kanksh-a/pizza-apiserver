...
import (
	...
	"github.com/programming-kubernetes/pizza-apiserver/pkg/apis/restaurant/v2alpha1"
...
func Install(scheme *runtime.Scheme) {
	...
	utilruntime.Must(scheme.SetVersionPriority(v1alpha1.SchemeGroupVersion, v1beta1.SchemeGroupVersion, v2alpha1.SchemeGroupVersion))
}
